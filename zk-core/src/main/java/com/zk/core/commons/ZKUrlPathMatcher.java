...
public class ZKSecUrlPathMatcher implements ZKSecPatternMatcher {
    ...
    protected boolean doMatch(String pattern, String path, boolean fullMatch) {
        ...
        String[] pattDirs = ZKStringUtils.tokenizeToStringArray(pattern, this.pathSeparator);
        String[] pathDirs = ZKStringUtils.tokenizeToStringArray(path, this.pathSeparator);
    ...
    public String extractPathWithinPattern(String pattern, String path) {
        String[] patternParts = ZKStringUtils.tokenizeToStringArray(pattern, this.pathSeparator);
        String[] pathParts = ZKStringUtils.tokenizeToStringArray(path, this.pathSeparator);
