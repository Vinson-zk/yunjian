...
//            System.out.println("[^_^:20190819-1806-001]:" + ZKJsonUtils.writeObjectJson(resultDoc));
            TestCase.assertNotNull(resultDoc);
...
//            System.out.println("[^_^:20190819-1806-002]:" + ZKJsonUtils.writeObjectJson(resultDoc));
            TestCase.assertNotNull(resultDoc);
            TestCase.assertEquals(zkBaseHelperDoc.getValue(), resultDoc.getValue());
            TestCase.assertNull(resultDoc.getName());
