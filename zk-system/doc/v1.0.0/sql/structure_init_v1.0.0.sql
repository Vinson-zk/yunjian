...
--
-- Host: 10.211.55.10    Database: zk-sys
-- ------------------------------------------------------
...
CREATE TABLE `t_sys_set_collection` (
  ...
  `c_group_code` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '集团代码',
  `c_compamy_code` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '公司代码',
  PRIMARY KEY (`c_pk_id`),
...
CREATE TABLE `t_sys_set_item` (
  ...
  `c_compamy_code` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '公司代码：仅公司专属配置类型时，有值',
  PRIMARY KEY (`c_pk_id`),
...
CREATE TABLE `t_sys_set_item_company_value` (
  ...
  `c_group_code` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '集团代码',
  `c_compamy_code` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '公司代码',
  PRIMARY KEY (`c_pk_id`)
