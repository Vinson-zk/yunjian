 ...
 */
@RestController
@RequestMapping(value = "${zk.path.admin}/${zk.path.sys}/org/sysOrgRank")
public class ZKSysOrgRankController extends ZKBaseController {
	...
	public ZKMsgRes sysOrgRankPost(@RequestBody ZKSysOrgRank sysOrgRank){
        ...
        return ZKMsgRes.asOk(sysOrgRank);
	}
	...
	public ZKMsgRes sysOrgRanksPageGet(ZKSysOrgRank sysOrgRank, HttpServletRequest hReq, HttpServletResponse hRes){
