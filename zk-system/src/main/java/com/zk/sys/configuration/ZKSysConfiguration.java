...
//        "classpath:zk.sys.mongo.properties",
        "classpath:zk.log.properties",
        "classpath:zk.sys.jdbc.properties"
        })
...
//        // # 默认语言；注意这里不影响到 localeResolver 的默认语言
        ZKWebUtils.setLocale(
                ZKLocaleUtils.distributeLocale(ZKEnvironmentUtils.getString("zk.sys.default.locale", "zh_CN")));
