...
//  public static final String[] configPath = { "classpath:mybatis/test_spring_context_mybatis.xml" };

    public static final String properties_file_path = "classpath:datasource/test_database.properties";
