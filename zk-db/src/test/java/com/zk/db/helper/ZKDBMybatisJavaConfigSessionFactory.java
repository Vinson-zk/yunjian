...
public class ZKDBMybatisJavaConfigSessionFactory extends ZKMybatisSessionFactory {
    ...
    protected static Logger logger = LoggerFactory.getLogger(ZKDBMybatisJavaConfigSessionFactory.class);
    ...
    public void rebuildSqlSessionFactory() {
        try {
            ...
            ps.setProperty("username", properties.getProperty("zk.db.dynamic.jdbc.username_w"));
            ps.setProperty("password", properties.getProperty("zk.db.dynamic.jdbc.password_w"));
...
//          configuration.addInterceptor(new SamplePlugins());
