...
import com.zk.db.helper.service.ZKDBService;

import junit.framework.TestCase;

/** 
* @ClassName: ZKDBServiceTest 
* @Description: TODO(simple description this class what to do.) 
* @author Vinson 
* @version 1.0 
*/
public class ZKDBServiceTest {
    ...
    public void test() {
        try {
            ...
            ZKDBService zkTestService = ctx.getBean(ZKDBService.class);
...
//          specialStr = "--";
    ...
    public void testTransactional2() {
        try {
            ...
            TestCase.assertNotNull(zkTe);
            TestCase.assertEquals(value, zkTe.getValue());
            TestCase.assertEquals(type, zkTe.getType().longValue());
        }
        catch(Exception e) {
            e.printStackTrace();
            TestCase.assertTrue(false);
